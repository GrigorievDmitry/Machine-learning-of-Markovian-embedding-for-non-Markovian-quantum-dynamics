...
for epoch in range(300):
    ...
    rho1 = model_1.get_evolution_continuous(2000, 0.1)
    rho2 = model_2.get_evolution_continuous(2000, 0.1)
    model_1.set_in_state(np.array([[1., 0.], [0., 1.]])/2)
    model_2.set_in_state(np.array([[1., 0.], [0., 1.]])/2)
    rho_zero1 = model_1.get_evolution_continuous(2000, 0.1)
    rho_zero2 = model_2.get_evolution_continuous(2000, 0.1)
    model_1.set_in_state(np.array([[0., 0.], [0., 1.]]))
    model_2.set_in_state(np.array([[0., 0.], [0., 1.]]))
